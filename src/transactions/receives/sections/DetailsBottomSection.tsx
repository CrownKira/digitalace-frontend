...
import { Totals } from "../ReceiveCreate";
...
export const DetailsBottomSection: FC<Props> = ({ totals, updateTotals }) => {
  ...
  const label = translate("resources.receives.fields.description");

  return (
    <Box display={{ sm: "block", md: "flex" }}>
      <Box flex={2} mr={{ sm: 0, md: "0.5em" }}>
        <RichTextInput source="description" resource="receives" label={label} />
      </Box>
