...
export const AdjustmentCreate: FC<CreateProps> = (props) => {
  return (
    <Create {...props}>
      <AdjustmentForm />
    </Create>
...
export const getTotals = (
  ...
  const lineItems = formData.adjustmentitem_set
    ? (formData.adjustmentitem_set as AdjustmentItem[]).map((lineItem) => {
...
export const validateReferenceUnicity = (props: any) =>
  validateUnicity({
    ...
    source: "reference",
    record: props.record,
    message: "resources.adjustments.validation.reference_already_used",
  });
