...
export const PurchaseOrderCreate: FC<CreateProps> = (props) => {
  return (
    <Create {...props}>
      <PurchaseOrderForm />
    </Create>
...
export const getTotals = (
  ...
  const lineItems = formData.purchaseorderitem_set
    ? (formData.purchaseorderitem_set as PurchaseOrderItem[]).map(
        (lineItem) => {
