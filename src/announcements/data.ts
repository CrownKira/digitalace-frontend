export const statuses = [
  { id: "DFT", name: "resources.announcements.data.statuses.draft" },
...
export const getStatus = (optionValue: string) => {
  return (
    ...
    "resources.announcements.data.statuses.draft"
  );
};

export const severities = [
  { id: "SUCC", name: "resources.announcements.data.severities.success" },
